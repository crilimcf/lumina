...
> `api/public/` é intencional. O workflow `Build Railway web fallback` recompila `web/` e publica o resultado nesse diretório para manter uma segunda via de entrega da interface. Não é fonte de desenvolvimento e não deve ser editado manualmente.
