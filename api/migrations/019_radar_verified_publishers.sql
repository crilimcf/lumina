...
WITH verified(name, url, priority) AS (
  VALUES
    ...
    ('PÚBLICO', 'https://www.publico.pt/ultimas', 18),
    ('Expresso', 'https://expresso.pt/', 18),
    ('Jornal de Notícias', 'https://www.jn.pt/ultimas', 16),
    ('Diário de Notícias', 'https://www.dn.pt/ultimas', 15),
    ('TSF', 'https://www.tsf.pt/ultimas', 15),
    ('Correio da Manhã', 'https://www.cmjornal.pt/maissobre/ultima-hora', 14),
    ('Record', 'https://www.record.pt/ultimas-noticias', 13),
    ('A Bola', 'https://www.abola.pt/ultimas-noticias', 13),
    ('O Jogo', 'https://www.ojogo.pt/ultimas', 13),
