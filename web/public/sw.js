 ...
 *
 * Pedidos para a API (outra origem) passam sempre direto à rede: nunca é
 * seguro guardar em cache uma resposta autenticada num dispositivo partilhado.
 */
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.origin !== self.location.origin) return; // API: sempre direto à rede
