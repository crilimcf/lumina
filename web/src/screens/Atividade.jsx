...
import { Bell, Check, DoorOpen, FileText, Globe2, Lock, Search, UserPlus, X } from 'lucide-react';
...
export function Atividade({ tab,setTab,setThread,setComp,threads,ping,toast,unreadCount=0,onUnreadChange }) {
  ...
  const openNotification=async n=>{await markRead(n);if(n.type==='new_room'||n.type==='room_invite')return setTab('rooms');if(n.actor_handle)return openPerson(n.actor_handle)};
